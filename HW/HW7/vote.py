...
def chooseCity() :
    if var.get() == 1 :
        ...
        photo.configure(file = "HW/HW6/img/barcelona.gif")
    elif var.get() == 2 :
        label2.configure(text = "베를린", bg="white", fg="black")
        photo.configure(file = "HW/HW6/img/berlin.gif")
    elif var.get() == 3 :
        label2.configure(text = "런던", bg="orange", fg="black" )
        photo.configure(file = "HW/HW6/img/london.gif")
    elif var.get() == 4 :
        label2.configure(text = "파리", bg="black", fg="white")
        photo.configure(file = "HW/HW6/img/paris.gif")
    elif var.get() == 5 :
        label2.configure(text = "베니스", bg="white", fg="black")
        photo.configure(file = "HW/HW6/img/venice.gif")
...
photo = tk.PhotoImage(file = "HW/HW6/img/europe.gif")
